...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // Arrow em vez de `function render(...)`: declaração de função é içada, e
    // com isso o TypeScript descarta o estreitamento de `canvas`/`gl` aqui
    // dentro (sete erros TS18047 sob strict). Criada depois das checagens de
    // null, a arrow herda o estreitamento. Comportamento idêntico — só a forma
    // da declaração muda, e `requestRender` continua podendo chamá-la.
